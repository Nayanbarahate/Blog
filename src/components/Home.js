...
const Home = () => {
    ...
    return (
        ...
        <div style={{display:"flex"}}>
            ...
            />
            <div style={{zIndex:"5",left:"-300px",position:"relative",top:"200px",color:"#ECECEC",fontSize:"30px",fontWeight:"600",height:"50px"}} className="pointer_cursor">{data[0].data[0].name}</div>
